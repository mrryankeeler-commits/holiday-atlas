...
- Checklist instance link(s):
  - [ ] <!-- e.g. docs/location-qa-checklists/generic-content-remediation-2026-04-17-batch-1.md -->

### Audit script output snippet (required when touching `data/locations/*.json`)
```text
# Paste output snippet from:
