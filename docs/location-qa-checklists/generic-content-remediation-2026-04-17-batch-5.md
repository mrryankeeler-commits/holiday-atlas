# Location QA Checklist — Generic Content Remediation 2026-04-17 (Batch 5)

- Batch doc: `docs/generic-content-remediation-2026-04-17.md`
- Batch ID: `generic-content-remediation-2026-04-17 / batch-5`
- Reviewed on (YYYY-MM-DD):
- Author:
- Reviewer:
- Audit command: `python3 scripts/audit_locations.py --fail-on-high`

## Destination: `vinales-cuba`
...
## Destination: `hoa-lu-ninh-binh-vietnam`
