# Import batch checklist — 2026-04-17

Source: GitHub Actions workflow run `24571086181` import step (CSV import in `stage` mode).

Use this exact source list for follow-up stubs (indexing + enrichment batching).
...
- IDs are preserved exactly as lowercase kebab-case from the import output.
- `jeonju-south-korea` was fuzzily resolved to existing `seoul-south-korea` and is **not** part of this 24-ID checklist.
