...
const COUNTRY_FLAG_PALETTES = {
  ...
  "armenia": { token: "flag-armenia", fill: "linear-gradient(180deg, #d90012 0 33.33%, #0033a0 33.33% 66.66%, #f2a800 66.66% 100%)", halo: "rgba(255,236,214,0.84)" },
  ...
  "finland": { token: "flag-finland", fill: "linear-gradient(90deg, transparent 0 28%, #003580 28% 46%, transparent 46%), linear-gradient(180deg, transparent 0 42%, #003580 42% 58%, transparent 58%), #ffffff", halo: "rgba(227,238,255,0.84)" },
  ...
  "ireland": { token: "flag-ireland", fill: "linear-gradient(90deg, #169b62 0 33.33%, #ffffff 33.33% 66.66%, #ff883e 66.66% 100%)", halo: "rgba(231,255,239,0.84)" },
  ...
  "kenya": { token: "flag-kenya", fill: "linear-gradient(180deg, #000000 0 28%, #ffffff 28% 34%, #bb0000 34% 66%, #ffffff 66% 72%, #006600 72% 100%)", halo: "rgba(244,244,244,0.84)" },
  ...
  "lebanon": { token: "flag-lebanon", fill: "radial-gradient(circle at 50% 50%, #007a3d 0 14%, transparent 15%), linear-gradient(180deg, #ed1c24 0 24%, #ffffff 24% 76%, #ed1c24 76% 100%)", halo: "rgba(255,232,232,0.84)" },
  ...
  "mali": { token: "flag-mali", fill: "linear-gradient(90deg, #14b53a 0 33.33%, #fcd116 33.33% 66.66%, #ce1126 66.66% 100%)", halo: "rgba(245,255,214,0.84)" },
  ...
  "netherlands": { token: "flag-netherlands", fill: "linear-gradient(180deg, #ae1c28 0 33.33%, #ffffff 33.33% 66.66%, #21468b 66.66% 100%)", halo: "rgba(230,238,255,0.84)" },
  ...
  "oman": { token: "flag-oman", fill: "linear-gradient(90deg, #db161b 0 28%, transparent 28%), linear-gradient(180deg, #ffffff 0 33.33%, #db161b 33.33% 66.66%, #007a3d 66.66% 100%)", halo: "rgba(255,231,231,0.84)" },
  ...
  "sweden": { token: "flag-sweden", fill: "linear-gradient(90deg, transparent 0 30%, #fecc00 30% 46%, transparent 46%), linear-gradient(180deg, transparent 0 42%, #fecc00 42% 58%, transparent 58%), #006aa7", halo: "rgba(228,243,255,0.84)" },
  ...
  "taiwan": { token: "flag-taiwan", fill: "radial-gradient(circle at 22% 22%, #ffffff 0 7%, transparent 8%), linear-gradient(90deg, #000095 0 38%, transparent 38%), linear-gradient(180deg, #000095 0 38%, transparent 38%), #fe0000", halo: "rgba(231,238,255,0.84)" },
  ...
  "thailand": { token: "flag-thailand", fill: "linear-gradient(180deg, #a51931 0 20%, #f4f5f8 20% 35%, #2d2a4a 35% 65%, #f4f5f8 65% 80%, #a51931 80% 100%)", halo: "rgba(233,238,247,0.84)" },
  "tunisia": { token: "flag-tunisia", fill: "radial-gradient(circle at 50% 50%, #ffffff 0 26%, transparent 27%), radial-gradient(circle at 46% 50%, #e70013 0 10%, transparent 11%), radial-gradient(circle at 49% 50%, #ffffff 0 7%, transparent 8%), radial-gradient(circle at 58% 50%, #e70013 0 4%, transparent 5%), #e70013", halo: "rgba(255,228,231,0.83)" },
  ...
  "yemen": { token: "flag-yemen", fill: "linear-gradient(180deg, #ce1126 0 33.33%, #ffffff 33.33% 66.66%, #000000 66.66% 100%)", halo: "rgba(244,244,244,0.84)" },
